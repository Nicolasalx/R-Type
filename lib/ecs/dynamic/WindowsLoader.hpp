...
//         DLLoader<T>(libPath), _handle(LoadLibrary(libPath.c_str()))
//     {
//         // if (!_handle) {
...
//     {
//         // void *function = GetProcAddress(_handle, functionName.c_str()); // dlsym(_handle, functionName.c_str());
//         // if (!function) {
...
//     {
//         close();
//         // _handle = LoadLibrary(libPath.c_str());
//         // if (!_handle) {
//             // throw std::runtime_error(GetLastError());
//         // }
